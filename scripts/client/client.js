...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("money:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("money:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("money:pinky", pinkyEventData);
	}
}
